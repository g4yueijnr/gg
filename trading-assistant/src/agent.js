...
- A rule in "error" status has paused itself; its order is already handled. To resume that intent, cancel_rule it (which clears any order) and create a fresh one - do not place a bare order alongside it.
